...
static VkResult VULKAN_CreateDeviceResources(SDL_Renderer *renderer, SDL_PropertiesID create_props)
{
    ...
    if (rendererData->device) {
        ...
        if (rendererData->supportsKHRGetPhysicalDeviceProperties2) {
            ...
            if (VULKAN_DeviceExtensionsFound(rendererData, 5, &deviceExtensionNames[5])) {
                deviceCreateInfo.enabledExtensionCount += 5;
                VkPhysicalDeviceDynamicRenderingFeaturesKHR enabledDynamicRenderingFeaturesKHR = { 0 };
                ...
                physicalDeviceFeatures2.features = rendererData->physicalDeviceFeatures;
