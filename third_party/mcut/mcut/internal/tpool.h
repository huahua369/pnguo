...
*/
    ...
    std::future<typename std::invoke_result_t<FunctionType()>::type> submit(uint32_t worker_thread_id, FunctionType f)
    //std::future<typename std::result_of<FunctionType()>::type> submit(uint32_t worker_thread_id, FunctionType f)
    {
        typedef typename std::invoke_result_t<FunctionType()>::type result_type;
