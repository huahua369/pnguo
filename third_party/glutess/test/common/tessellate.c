...
void destroy_tess_context(struct TessContext_s *ctx) { free(ctx); }
...
void combine(const GLdouble newVertex[3], const void *neighborVertex_s[4], const GLfloat neighborWeight[4],
