...
ID_occlusionTexture
ID_diffuseTexture
ID_specularGlossinessTexture
ID_brdfTexture u_brdfLUT;//u_GGXLUT
ID_CharlieLUTTexture
ID_SheenELUTTexture

ID_sheenColorTexture
ID_sheenRoughnessTexture
ID_specularTexture
ID_specularColorTexture
ID_transmissionTexture
ID_thicknessTexture
ID_clearcoatRoughnessTexture
ID_clearcoatNormalTexture
ID_iridescenceTexture
ID_iridescenceThicknessTexture

ID_anisotropyTexture 
ID_shadowMap
ID_SSAO
ID_transmissionFramebufferTexture
*/
//------------------------------------------------------------
// UV getters
//------------------------------------------------------------
